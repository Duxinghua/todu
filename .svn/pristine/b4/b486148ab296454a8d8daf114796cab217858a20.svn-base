<template>
  <div class="self-container">
    <div class="self-box">
      ...
      <div class="self-box2">
        ...
        <div class="search-row">
          ...
          <el-input v-model="form.searchProject" :clearable="true" placeholder="请输入项目名称" />
        </div>
        <div class="search-row">
          ...
          <div>
            <el-row :gutter="20" style="display: flex;margin-bottom: 20px">
              <el-col :span="12" class="self-input-box" style="margin-right: 10px">
                ...
                <el-select v-model="weeklyForm.projectId" :disabled="buttonDisabled" placeholder="请选择项目" size="small" class="self-input" popper-class="self-input" @change="projectRoleList">
                  <el-option
    ...
    <!-- 选择项目 -->
    <el-dialog title="项目列表" :show-close="false" :visible.sync="projectDialogVisible">
      <el-table
...
<script>
import { weekProjectListOne, weekProjectList, reportView, weekUpdate, weekDate, weekAdd } from '@/api/monthReport'
import { projectList, projectRoleList } from '@/api/dayReportList'
import Tinymce from '@/components/Tinymce'
export default {
  name: 'MonthProjectList1',
  components: { Tinymce },
