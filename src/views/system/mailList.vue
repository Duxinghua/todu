...
export default {
  ...
  methods: {
    ...
    // 加载用户列表
    async getList() {
      await deptPersonList({ deptId: this.currentDeptId, pageNum: this.pageNum, pageSize: this.pageSize, workNumberKeyWord: this.workNumberKeyWord, userNameKeyWord: this.userNameKeyWord }).then(res => {
        const {
