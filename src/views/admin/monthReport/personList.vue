  ...
  <div class="self-container">
    <div class="self-box">
      ...
      <div v-else class="self-box3" style="flex: 1;flex-wrap: wrap;">
        <el-button type="primary" :disabled="exportDisabled" @click="exportFile">导出</el-button>
    ...
    >
      <div slot="title">
        <div style="display: flex;align-items: center;justify-content: space-between;margin-bottom: 10px;padding: 0 20px">
          ...
          <div><span style="font-size: 12px">第{{ form.currentWeek }}周</span><span style="font-size: 12px;color: #8f8f8f;margin-left: 10px">({{ dateFormat(form.startDate) + '-' + dateFormat(form.endDate) }})</span></div>
        </div>
      </div>
          ...
          <div>
            <el-row :gutter="20" style="display: flex;margin-bottom: 20px">
              <el-col :span="12" class="self-input-box" style="margin-right: 10px">
                ...
                <el-input v-model="form.projectName" :readonly="readonly" placeholder="请输入内容" size="small" class="self-input" />
              </el-col>
              <el-col :span="12" class="self-input-box" style="margin-left: 10px">
                <div class="self-title">项目角色</div>
                <el-input v-model="form.projectRole" :readonly="readonly" placeholder="请输入内容" size="small" class="self-input" />
              </el-col>
            </el-row>
            <el-row :gutter="20" style="display: flex">
              <el-col :span="12" class="self-input-box" style="margin-right: 10px">
                <div class="self-title">时间（天）</div>
                <el-input v-model="form.projectDate" :readonly="readonly" placeholder="请输入内容" size="small" class="self-input" />
              </el-col>
              <el-col :span="12" class="self-input-box" style="margin-left: 10px">
                <div class="self-title">工作地点</div>
                <el-input v-model="form.workPlace" :readonly="readonly" placeholder="请输入内容" size="small" class="self-input" />
              </el-col>
            </el-row>
            ...
            <el-row style="margin-top: 10px">
              <h3>存在的问题</h3>
              <div style="width: 100%;">
                <div class="self-content" v-html="form.question" />
              </div>
            </el-row>
            <el-row style="margin-top: 10px">
              <h3>下步计划  /  工作重点提示</h3>
...
export default {
  ...
  methods: {
    ...
    exportFile() {
      this.$router.push('/sMonthReport/totalReport')
    },
